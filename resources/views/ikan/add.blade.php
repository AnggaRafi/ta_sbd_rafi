...
<input type="text" class="form-control" id="ikan" name="id_ikan">
</div>
...
<input type="text" class="form-control" id="harga_ikan" name="harga_ikan">
</div>
...
<input type="text" class="form-control" id="stok_ikan" name="stok_ikan">
</div>
...
<input type="submit" class="btnbtn-primary" value="Tambah" />
</div>
